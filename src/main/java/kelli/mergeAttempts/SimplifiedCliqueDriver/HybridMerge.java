...
public class HybridMerge {
  ...
  // static String participant = "JC";
   ...
   public static MergeStatsRecord init(){
	  ...
	  elapsedTimeMin = elapsedTime/(60*1000F);
	  System.out.println("   total elapsed time: "+elapsedTimeMin+" min ");
	  String outputFile = "data/Kelli/FriendGrouperResults/"+participantID+"_RecommendedLists.txt";
	  ioHelp.printCliqueNamesToFile(outputFile, networkCliques, SubgroupCliques);
