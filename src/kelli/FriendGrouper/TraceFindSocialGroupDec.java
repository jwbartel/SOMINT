...
import kelli.mergeAttempts.SetDiffV2;
...
public class TraceFindSocialGroupDec {
...
private static void doIntersection(){
	  ...
	  //compareCliques();
	  Collection<Set<Integer>> intersectionCliques = IntersectionV1.doIntersectionMerges(cliques);
...
private static void findCliquesInLargeGroups(Collection<Set<Integer>> intersectionCliques){
	   ...
	   Collection<Set<Integer>> SetDiffCliques;
	   SetDiffCliques = BKcliqueFind2.getAllMaximalCliques();
	   System.out.println("all max cliques: "+SetDiffCliques.size());
	   SetDiffCliques = SetDiffV2.doSetDiffMerges(SetDiffCliques, threshold);
