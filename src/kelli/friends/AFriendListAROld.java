...
public class AFriendListAROld implements ExecutableCommand {
	public Object execute(Object theFrame) {
		...
		ObjectEditor.setPropertyAttribute(AFriendList.class, "FriendListName", AttributeNames.POSITION, 0);
		ObjectEditor.setPropertyAttribute(AFriendList.class, "FriendListSelection", AttributeNames.POSITION, 1);
		ObjectEditor.setPropertyAttribute(AFriendList.class, "Friends", AttributeNames.POSITION, 2);
		ObjectEditor.setPropertyAttribute(AFriendList.class, "SaverCanceller", AttributeNames.POSITION, 3);
		...
		ObjectEditor.setPropertyAttribute(AFriendList.class, "Friends", AttributeNames.HORIZONTAL_GAP, 40);
