...
public class MergeCliques {
   ...
   private static float varyPercentage = .2F;   // try .1, .15, .2   checking percentDifferent, so 14% different means 86% the same
   private static float varyLargerPercentage = .25F;
   private static String inputCliquesFile = "data/Kelli/Cliques/TH_BKCliques.txt";
   private static String outputMergedFile = "data/Kelli/Results/TH_20_MergedCliques.txt";
