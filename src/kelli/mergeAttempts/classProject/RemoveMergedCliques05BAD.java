...
public class RemoveMergedCliques05BAD {
   ...
   private static float varyPercentage = .05F;   // try .1, .15, .2   checking percentDifferent, so 14% different means 86% the same
   private static String inputCliquesFile = "data/Kelli/Cliques/KB_BKCliques.txt";
   private static String outputMergedFile = "data/Kelli/RemoveMergedResults/KB_05_MergedCliques.txt";
